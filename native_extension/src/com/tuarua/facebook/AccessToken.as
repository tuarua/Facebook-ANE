...
public class AccessToken {
    ...
    public function AccessToken(data:Object = null) {
        ...
        var lastRefreshsDate:Date = new Date();
        var dataAccessExpirationTimeDate:Date = new Date();
        expiresDate.setTime(Date.parse(data["expires"]));
        lastRefreshsDate.setTime(Date.parse(data["lastRefresh"]));
        dataAccessExpirationTimeDate.setTime(Date.parse(data["dataAccessExpirationTimeDate"]));
        _expires = expiresDate;
        _lastRefresh = lastRefreshsDate;
        _dataAccessExpirationTime = dataAccessExpirationTimeDate;
